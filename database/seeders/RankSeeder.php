...
class RankSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            [12,'စာရင်းကိုင်(၃)', 9, 2, 12],
            [13,'အကြီးတန်းစာ‌ရေး', 9, 2, 86],
            [14,'စာရင်းကိုင်(၄)', 10, 2, 12],
            [15,'အငယ်တန်းစာရေး', 10, 2, 78],
            [16,'ယာဉ်မောင်းစက်ပြင်', 10, 2, 1],
            [17,'စာကူးစက်လှည့်', 11, 2, 1],
            [18,'ယာဉ်မောင်း(၅)', 11, 2, 36],
            [19,'ရုံးအကူမှူး', 11, 2, 2],
            [20,'ရုံးအကူ', 12, 2, 37],
