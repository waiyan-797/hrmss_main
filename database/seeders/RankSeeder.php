...
class RankSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $items = [
            ...
            [12,'အကြီးတန်းစာ‌ရေး', 9, 2, 86,13],
            [13,'စာရင်းကိုင်(၃)', 9, 2, 12,12],
            [14,'အငယ်တန်းစာရေး', 10, 2, 78,15],
            [15,'စာရင်းကိုင်(၄)', 10, 2, 12,14],
            [16,'ယာဉ်မောင်းစက်ပြင်(၄)', 10, 2, 1,16],
            [17,'ရုံးအကူမှူး', 11, 2, 2,19],
            [18,'စာကူးစက်လှည့်အကူ', 11, 2, 1,17],
            [19,'ယာဉ်မောင်း(၅)', 11, 2, 36,18],
