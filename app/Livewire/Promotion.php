...
class Promotion extends Component
{
    ...
    public function add_new()
    {
        ...
        $this->reset([
            'staff_name', 'rank_name', 'previous_rank_name','promotion_date','order_no'
        ]);
    ...
    {
        $this->resetValidation();
        $this->reset(['staff_name', 'rank_name','previous_rank_name','promotion_date','order_no'
        ]);
        $this->confirm_edit = false;
    ...
    public function updatepromotion()
    {
        ...
        $promotion->update([
            'staff_id' => $this->staff_name,
            'rank_id' => $this->rank_name,
            'previous_rank_id'=>$this->rank_name,
            'promotion_date'=>$this->promotion_date,
            'order_no'=>$this->order_no,
