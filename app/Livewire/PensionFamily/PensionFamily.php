    ...
    public function go_word()
{
    ...
    $table->addRow();
    $headerTitles = [
        'စဥ်', 'ကွယ်လွန်ဝန်ထမ်းအမည်', 'တာဝန်ထမ်းဆောင်ခဲ့သည့်ရာထူး',
        'စတင်အမှုထမ်းသောနေ့', 'အမှုထမ်းသက်ဆုံးခန်းတိုင်သည့်နေ့', 
        'လုပ်သက်', 'ကွယ်လွန်သည့်နေ့', 'မိသားစုပင်စင်ခံစားမည့်အမည်',
        'ကွယ်လွန်သူသည်ပင်စင်စားဖြစ်လျှင်ပင်စင်ယူသောနေ့', 
        'ကွယ်လွန်သူနှင့်တော်စပ်ပုံ', 'မိသားစုပင်စင်ခံစားသည့်နေ့', 
        'ထုတ်ယူလိုသည့်ဘဏ်', 'ရရှိမည့်ပင်စင်လစာ/ဆုငွေ', 
