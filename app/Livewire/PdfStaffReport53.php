...
class PdfStaffReport53 extends Component
{
    ...
    public function go_word($staff_id)
    {
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->height_feet) . 'ပေ' . en2mm($staff->height_inch) . 'လက်မ');
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->military_gazetted_date), ['align' => 'right']);

        $table->addRow();
        $table->addCell(4000)->addText('(င) တပ်ထွက်သည့်နေ့');
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->military_leave_date), ['align' => 'right']);
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->military_pension), ['align' => 'right']);
        ...
        foreach ($staff->staff_educations as $education) {
            ...
            $table->addCell(2000)->addText('-', ['align' => 'center']);
            $table->addCell(5000)->addText($education->education_group->name . ',' . $education->education_type->name . ',' . $education->education->name . '၊', ['align' => 'right']);
        }
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText($staff->is_parents_citizen_when_staff_born ? 'ဟုတ်' : 'မဟုတ်', ['align' => 'right']);
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->join_date), ['align' => 'right']);
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText($staff->is_direct_appointed ? 'ဟုတ်' : 'မဟုတ်', ['align' => 'right']);
        ...
        foreach ($staff->postings as $index => $posting) {
            ...
            $table->addCell(2000)->addText(en2mm($posting->from_date));
            $table->addCell(2000)->addText(en2mm($posting->to_date));
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText($staff->family_in_politics?'ရှိ':'မရှိ', ['align' => 'right']);
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText($staff->has_military_friend ? 'ရှိ' : 'မရှိ', ['align' => 'right']);
        ...
        foreach ($staff->abroads as $index => $abroad) {
            ...
            $table->addCell(2000)->addText(en2mm($abroad->from_date) . '-' . en2mm($abroad->to_date));
        }
        $table = $section->addTable();
        $table->addRow();
        ...
        $table->addCell(2000)->addText('-', ['align' => 'center']);
        $table->addCell(5000)->addText(en2mm($staff->punishments->count()) ? 'ရှိ' : 'မရှိ', ['align' => 'right']);
