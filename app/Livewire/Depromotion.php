...
class Depromotion extends Component
{
    ...
    public function add_new()
    {
        ...
        $this->reset(['from_date', 'to_date', 'previous_rank_name', 'depromoted_rank_name']);
    ...
    {
        $this->resetValidation();
        $this->reset(['staff_name', 'from_date', 'to_date', 'previous_rank_name', 'depromoted_rank_name']);
        $this->confirm_edit = false;
