...
class Salary extends Component
{
    ...
    protected $rules = [
        ...
        'previous_salary_before_promotion' => 'required',
        'previous_salary_before_promotion_day' => 'required|date',
        'addition' => 'required',
    ...
    public function add_new()
    {
        ...
        $this->reset([
            ...
            'previous_salary_before_promotion',
            'previous_salary_before_promotion_day',
            'addition',
            'addition_education',
            'addition_ration',
            'deduction',
    ...
    public function createSalary()
    {
        ...
        ModelsSalary::create([
            ...
            'previous_salary_before_promotion' => $this->previous_salary_before_promotion,
            'previous_salary_before_promotion_day' => $this->previous_salary_before_promotion_day,
    ...
    public function edit_modal($id)
    {
        ...
        $this->previous_salary_before_promotion = $salary->previous_salary_before_promotion;
        $this->previous_salary_before_promotion_day = $salary->previous_salary_before_promotion_day;
    ...
    public function render()
{
    ...
    if ($this->salary_search) {
        $this->resetPage();
        $salaryQuery->whereHas('staff', function ($query) use ($salarySearch) {
            $query->where('name', 'LIKE', $salarySearch);
        });
    }
    $salaries = $salaryQuery->paginate();
