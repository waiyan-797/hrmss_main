...
class A06 implements FromView ,WithStyles
{
    ...
    */
    ...
    $sheet->getColumnDimension('A')->setWidth(7.1);
    $sheet->getColumnDimension('B')->setWidth(21.33);
    $sheet->getColumnDimension('C')->setWidth(22.88);
    $sheet->getColumnDimension('D')->setWidth(15.44);
    $sheet->getColumnDimension('E')->setWidth(15.44);
    $sheet->getColumnDimension('F')->setWidth(20.88);
    $sheet->getColumnDimension('G')->setWidth(44.33);
    ...
    $sheet->getRowDimension(5)->setRowHeight(68.3);
    $sheet->getRowDimension(6)->setRowHeight(34.5);
    $sheet->getRowDimension(7)->setRowHeight(43.2);
    $sheet->getRowDimension(8)->setRowHeight(43.2);
    $sheet->getRowDimension(9)->setRowHeight(43.5);
    $sheet->getRowDimension(10)->setRowHeight(43.2);
    $sheet->getRowDimension(11)->setRowHeight(74.3);
    $sheet->getRowDimension(12)->setRowHeight(64.8);
    $sheet->getRowDimension(13)->setRowHeight(64.8);
