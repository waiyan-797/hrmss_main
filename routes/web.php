...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/pdf_staff_report', PdfStaffReport::class)->name('pdf_staff_report');
    Route::get('/pdf_staff_report18', PdfStaffReport18::class)->name('pdf_staff_report18');
    Route::get('/pdf_staff_report53', PdfStaffReport53::class)->name('pdf_staff_report53');
    Route::get('/pdf_staff_report15', PdfStaffReport15::class)->name('pdf_staff_report15');
    Route::get('/pdf_staff_report17', PdfStaffReport17::class)->name('pdf_staff_report17');
    Route::get('/pdf_staff_report19', PdfStaffReport19::class)->name('pdf_staff_report19');
    Route::get('/pdf_staff_report71', PdfStaffReport71::class)->name('pdf_staff_report71');
