...
$classes = ($active ?? false)
            ...
            ? 'inline-block p-4 text-blue-800 bg-gray-400 font-bold rounded-t-lg active dark:bg-gray-800 dark:text-blue-500'
            : 'inline-block p-4 rounded-t-lg bg-gray-300  text-blue-600 hover:text-gray-600 hover:bg-gray-50 dark:hover:bg-gray-800 dark:hover:text-gray-300'
@endphp
