<div class="overflow-x-auto  h-[83vh] overflow-y-auto">
    ...
    <table class="w-full border-collapse border border-black mt-4">
        <thead class="bg-white">
            ...
            <tr>
                <th class="border border-black p-2" colspan="12">1.4.B Propotion of Positions by (a) Sex,(b) Age,(c) Persons with disabilitie,in public institutions compared to national distribution</th>
            </tr>
        </thead>
        <thead class="bg-white">
            <tr>
                <th class="border border-black p-2" colspan="2">Name of Ministries/Organizations</th>
