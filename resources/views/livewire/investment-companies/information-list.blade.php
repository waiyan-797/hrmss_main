    ...
    <table class="w-full border-collapse border border-black mt-4">
        ...
        <thead class="bg-white">
            <tr>
                ...
                <th class="border border-black p-2" colspan="6">Age Group</th>
            ...
            <tr>
                <th class="border border-black p-2">Male</th>
                <th class="border border-black p-2">Female</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr class="text-center">
                ...
                <td class="border border-black p-2">Peon</td>
                <td class="border border-black p-2"></td>
                <td class="border border-black p-2"></td>
                <td class="border border-black p-2"></td>
                <td class="border border-black p-2"></td>
