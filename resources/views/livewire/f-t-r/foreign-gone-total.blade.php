                                        ...
                                        @foreach($allCountries as $index => $countryId)
                                            <tr>
                                                ...
                                                {{-- <td class="border border-black text-center p-2">{{
                                                    $staff->abroads->firstWhere('country_id', $countryId)?->country?->name ??
                                                    $staff->trainings->firstWhere('country_id', $countryId)?->country?->name }}</td> --}}
                                                ...
                                                <td class="border border-black text-center p-2">
                                                    {{ en2mm($staff->trainings->where('country_id', $countryId)->count()) }}</td>

                                                <!-- Count for abroads in this country -->
                                                <td class="border border-black text-center p-2">
                                                    {{ en2mm($staff->abroads->where('country_id', $countryId)->count()) }}</td>
