        ...
        <ul class="space-y-2">
            ...
            <li>
                <livewire:side-nav-drop-down
                    ...
                    '
                    dropdown_id="education_dropdown"
                    :lists="[
