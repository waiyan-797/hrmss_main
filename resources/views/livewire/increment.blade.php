    ...
    <div class="flex justify-center w-full h-[83vh] overflow-y-auto">
        <div class="w-full mx-auto px-3 py-4">
            @include('table', [
                ...
                'columns' => ['စဉ်', 'ဝန်ထမ်းအမည်','ရာထူး','အနိမ့်ဆုံးလစာ','နှစ်တိုးရရှိသည့်လစာငွေ','အမြင့်ဆုံးလစာ','နှစ်တိုးတိုးသည့်ရက်','နှစ်တိုးအကြိမ်အရေအတွက်','အမိန့်အမှတ်','မှတ်ချက်','လုပ်ဆောင်ချက်'],
