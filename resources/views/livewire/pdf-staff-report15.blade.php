        ...
        <div class="w-full mx-auto px-3 py-4">
            ...
            <div class="md:w-full p-4">
                ...
                <div class="flex justify-between w-full mb-4">
                    ...
                    <label for="" class="md:w-5">-</label>
                    <label for="name"
                        class="md:w-3/5">{{ collect([$staff->ethnic_id ? $staff->ethnic->name : '-', $staff->religion_id ? $staff->religion->name : '-'])->filter()->implode('၊') }}</label>
                </div>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" class="border border-black text-center p-2">
                                    သင်တန်းတက်ခြင်းဖြစ်လျှင် အကြိမ်မည်မျှဖြင့်အောင်မြင်သည်</th>
                                <th rowspan="2" class="border border-black text-center p-2">
                                ...
                                @foreach ($staff->spouses as $spouse)
                                    <tr>
                                        ...
                                        <td class="border border-black p-2">
                                            {{ $spouse->ethnic->name . '/' . $spouse->religion->name }}</td>
                ...
                <div class="mb-4">
                    <div class="flex justify-start mb-8">
                        ...
                        <p>အထက်ပါ အချက်အလက်များကို မှန်ကန်သည့်အတိုင်းဖြည့်သွင်းရေးသားပါကြောင်း ကိုယ်တိုင်
                            လက်မှန်ရေးထိုးပါသည်။</p>
                    </div>
