<div class="relative overflow-x-auto shadow-md sm:rounded-lg mb-5">
    ...
    @endif
    <div class="font-arial text-md uppercase text-white bg-blue-700 py-3 px-6 font-semibold flex flex-row justify-between items-center">
        {{ $title }}
        <div class="flex flex-row gap-3">
            <div class="relative">
                ...
                <input wire:model.live='{{ $search_id }}' type="text" id="{{ $search_id }}" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-64 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="Search for {{$title}}">
            </div>
            <button wire:click='add_new' type="button" class="text-blue-500 bg-white border border-white hover:bg-blue-200 hover:text-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:text-blue-800 dark:border-gray-200 dark:hover:text-blue-700 dark:focus:ring-blue-700 dark:hover:bg-blue-200 dark:bg-gray-200">
