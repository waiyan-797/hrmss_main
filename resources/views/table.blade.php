    ...
    <div class="font-arial text-md uppercase text-white bg-blue-700 py-3 px-6 font-semibold flex flex-row justify-between items-center">
        ...
        <div class="flex flex-row gap-3">
            <div class="relative">
                ...
                <input wire:model.live='{{ $search_id }}' type="text" id="{{ $search_id }}" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-64 bg-gray-50 focus:ring-blue-500 focus:border-blue-500" placeholder="{{$title}} ရှာဖွေရန်">
            </div>
