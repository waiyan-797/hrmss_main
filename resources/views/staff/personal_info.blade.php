<div class="grid grid-cols-4 gap-4 py-5">
    ...
    <div>
        ...
        <x-date-picker wire:model="dob" id="dob" name="dob" class="block w-full mt-1"/>
...
/>
    ...
    <div>
        ...
        <x-date-picker wire:model="military_join_date" id="military_join_date" name="military_join_date" class="block w-full mt-1"/>
    ...
    <div>
        ...
        <x-date-picker wire:model="military_gazetted_date" id="military_gazetted_date"  name="military_gazetted_date" class="block w-full mt-1"/>
    ...
    <div>
        ...
        <x-date-picker wire:model="military_leave_date" id="military_leave_date"  name="military_leave_date" class="block w-full"/>
    ...
    <div>
        ...
        <x-date-picker wire:model="veteran_date" id="veteran_date"  name="veteran_date" class="block w-full mt-1"/>
