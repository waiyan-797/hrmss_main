<div class="fixed z-50 inset-0 overflow-y-auto bg-gray-900 bg-opacity-20 flex justify-center items-center text-left" wire:ignore.self>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-96 p-4 h-[83vh] overflow-y-auto">
        ...
        <form wire:submit.prevent="{{$submit_form}}">
            ...
            <div class="mb-4">
                <label for="from_date" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">မှ
                </label>
                <input required type="date" wire:model="from_date" id="from_date" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('from_date') <span class="mt-1 text-red-500 text-xs font-arial font-semibold">{{ $message }}</span> @enderror
            </div>
            <div class="mb-4">
                <label for="to_date" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">ထိ
                </label>
                <input required type="date" wire:model="to_date" id="to_date" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('to_date') <span class="mt-1 text-red-500 text-xs font-arial font-semibold">{{ $message }}</span> @enderror
            </div>
            <div class="mb-4">
                <label for="qty" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">အရေအတွက်
                </label>
                <input required type="number" wire:model="qty" id="qty" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('qty') <span class="mt-1 text-red-500 text-xs font-arial font-semibold">{{ $message }}</span> @enderror
            </div>
            <div class="mb-4">
                <label for="order_no" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">ရုံးမိန့်
                </label>
            ...
            <div class="mb-4">
                <label for="remark" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">မှတ်ချက်
                </label>
