<div class="fixed z-50 inset-0 overflow-y-auto bg-gray-900 bg-opacity-20 flex justify-center items-center text-left" wire:ignore.self>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-96 p-4">
        ...
        <form wire:submit.prevent="{{$submit_form}}">
            ...
            <div class="mb-4">
                <label for="min_salary" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">Min Salary</label>
            ...
            <div class="mb-4">
                <label for="increment" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">Increment</label>
            ...
            <div class="mb-4">
                <label for="max_salary" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">Max Salary,</label>
            ...
            <div class="mb-4">
                <label for="staff_type" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">Staff Type</label>
                <div class="relative">
                    <select
