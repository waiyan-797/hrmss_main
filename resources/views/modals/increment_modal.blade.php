    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-96 p-4  h-[83vh] overflow-y-auto">
        ...
        <form wire:submit.prevent="{{$submit_form}}">
            ...
            <div class="mb-4">
                ...
                <input  readonly required type="text" wire:model="min_salary" id="min_salary" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('min_salary') <span class="mt-1 text-red-500 text-xs font-arial font-semibold">{{ $message }}</span> @enderror
            </div>
            <div class="mb-4">
                <label for="increment" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">နှစ်တိုး</label>
                <input  readonly required type="text" wire:model="increment" id="increment" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div class="mb-4">
                ...
                <input readonly required type="text" wire:model="max_salary" id="max_salary" class="font-arial bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                @error('max_salary') <span class="mt-1 text-red-500 text-xs font-arial font-semibold">{{ $message }}</span> @enderror
            </div>
            <div class="mb-4">
                <label for="increment_date" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">နှစ်တိုးတိုးသည့်နေ့</label>
            ...
            <div class="mb-4">
                <label for="increment_time" class="block mb-1 text-gray-600 dark:text-blue-500 font-arial">နှစ်တိုးတိုးသည့်အကြိမ်အရေအတွက်</label>
