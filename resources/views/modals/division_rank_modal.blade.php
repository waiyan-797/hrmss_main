<div class="fixed z-50 inset-0 overflow-y-auto bg-gray-900 bg-opacity-20 flex justify-center items-center text-left " wire:ignore.self>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-96 p-4  h-[83vh] overflow-y-auto">
        ...
        <form wire:submit.prevent="{{$submit_form}}">
            <div class="mb-4">
                <label for="division_name" class="block mb-1 text-gray-600 dark:text-green-500 font-arial">ဌာနခွဲ</label>
                <div class="relative">
                    <select
            ...
            <div class="mb-4">
                <label for="rank_name" class="block mb-1 text-gray-600 dark:text-green-500 font-arial">
                    ရာထူး
                </label>
                <div class="relative">
                    <select
            ...
            <div class="mb-4">
                <label for="allowed_qty" class="block mb-1 text-gray-600 dark:text-green-500 font-arial">ဖွဲ့စည်းပုံ</label>
                <x-text-input wire:model="allowed_qty" id="allowed_qty" name="allowed_qty" type="integer" class="mt-1 block w-full"/>
